...
PACKAGES = [
    ...
    },
    {
        ...
        "hero_icon": "gavel",
        "status": ("Доступно", "live"),
        "lead": "Профессиональный ИИ-помощник для работы с госзакупками: анализ по ссылке, риски по документам, ответы с опорой на 44-ФЗ и 223-ФЗ.",
        "sections": lambda: [
            section(
                "target",
                "Зачем нужен этот пакет",
                ...
                <p><strong>Пакет «Тендерный специалист»</strong> за секунды анализирует десятки страниц документации, находит скрытые риски и подсказывает, стоит ли участвовать в процедуре. Вы получаете ответы не из общих рассуждений, а с опорой на актуальные 44-ФЗ, 223-ФЗ и подзаконные акты, с точными ссылками на источники.</p>
            ...
            section(
                ...
                "Что внутри пакета",
                card_grid([
                    {"icon": "scale", "title": "Базовые законы о закупках", "text": "44-ФЗ и 223-ФЗ с актуальными изменениями — процедуры, требования к участникам, контрактная логика.", "meta": "44-ФЗ, 223-ФЗ"},
                    {"icon": "gavel", "title": "Антимонопольный блок", "text": "135-ФЗ и разъяснения ФАС — нормы конкуренции, допуск, ограничения, оспаривание формулировок.", "meta": "135-ФЗ, разъяснения ФАС"},
                    {"icon": "file-text", "title": "Смежные подзаконные акты", "text": "Постановления Правительства и федеральные акты для проверки специальных условий, ограничений и процедур.", "meta": "ПП РФ, федеральные акты"},
                ]),
            ),
            section(
                "layers",
                "Киллер-фичи для вашей работы",
                card_grid([
...
<head>
  ...
  <link rel="stylesheet" href="../css/package-pages.css?v=2">
</head>
