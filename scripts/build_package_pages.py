...
PACKAGES = [
    ...
    },
    {
        ...
        "meta_description": "ИИ-эксперт для разбора бухгалтерской, финансовой и налоговой отчётности юридических лиц.",
        "hero_icon": "chart",
        "status": ("Скоро", "soon"),
        "lead": "ИИ-эксперт для разбора бухгалтерской, финансовой и налоговой отчётности юридических лиц — структурированный анализ за минуты.",
        "sections": lambda: [
            section(
                "chart",
                "Зачем нужен этот пакет",
    ...
    },
    {
        ...
        "meta_description": "Профессиональный ИИ-эксперт для работы с госзакупками. Разбор тендера по ссылке с опорой на 44-ФЗ, 223-ФЗ, 615-ПП, 135-ФЗ, 63-ФЗ, ПП РФ и ведомственные акты.",
        "hero_icon": "gavel",
        "status": ("Доступно", "live"),
        "lead": "Профессиональный ИИ-эксперт для работы с госзакупками: анализ по ссылке, риски по документам, ответы с опорой на актуальную нормативную базу — законы, постановления Правительства и ведомственные акты.",
        "sections": lambda: [
            section(
                "target",
                "Зачем нужен этот пакет",
                ...
                <p><strong>Пакет «Тендерный специалист»</strong> за секунды анализирует десятки страниц документации, находит скрытые риски и подсказывает, стоит ли участвовать в процедуре. Вы получаете ответы не из общих рассуждений, а с опорой на актуальную нормативную базу пакета — 44-ФЗ, 223-ФЗ, 615-ПП, 135-ФЗ, 63-ФЗ, постановления Правительства (1005-ПП, 1236-ПП, 1875-ПП, 238-ПП, 2571-ПП, 2604-ПП, 878-ПП), ведомственные акты (567-ПР, 158Н, 258-Н) — с точными ссылками на источники.</p>
            ...
            section(
                ...
                <p class="pkg-note"><em>Тест доступен один раз на пакет. Никаких скрытых списаний со счёта приложения: просто нажмите «Попробовать».</em></p>
                """,
            ),
            section(
                "stack",
                "Что внутри пакета",
                card_grid([
                    {"icon": "scale", "title": "Федеральные законы", "text": "Контрактная система, корпоративные закупки, защита конкуренции и смежные ограничения для участников процедур.", "meta": "44-ФЗ, 223-ФЗ, 615-ПП, 135-ФЗ, 63-ФЗ"},
            ...
            section(
                ...
                bullet_list([
                    ...
                    "Консультанты по 44-ФЗ, 223-ФЗ и 615-ПП — опора на документы, а не на память, уверенность в каждом ответе клиенту",
                ]),
            ),
            section(
                "shield",
            ...
            section(
                ...
                price_grid([
                    ...
                    {"label": "Полный доступ", "value": "2 990 ₽ / мес", "note": "Ответы модели в чате списываются со счёта ИИ. Подключение пакета — со счёта приложения.", "featured": True},
                ]),
            ),
            final_cta(
    ...
    {
        "slug": "expert-opinion",
        "filename": "expert-opinion.html",
        "title": "Экспертное мнение",
        "meta_title": "Пакет «Экспертное мнение» — Zakon-AI",
        ...
        "sections": lambda: [
            section(
                ...
                <p><strong>Пакет «Экспертное мнение»</strong> — режим, в котором вопрос одновременно разбирают несколько сильных моделей. Затем самая продвинутая собирает итог: где модели согласны, где расходятся, какие риски у разных подходов.</p>
            ...
            trial_section(
                "<p>Прежде чем использовать режим в критичных решениях, попробуйте его на своих документах. Доступно <strong>5 экспертных запросов</strong> бесплатно.</p>",
                [
                    "5 экспертных запросов с разбором несколькими моделями",
                    "Полноценный сводный итог со ссылками на документы",
                    "Без списания со счёта приложения за подключение теста",
                ],
            ...
            section(
                ...
                "Стоимость",
                price_grid([
                    {"label": "Тест", "value": "5 вопросов бесплатно", "note": "Один раз на пакет, без списания со счёта приложения"},
                    {"label": "Полный доступ", "value": "2 990 ₽ / мес", "note": "Экспертный запрос ≈ 45–90 ₽ со счёта ИИ. Подключение — со счёта приложения.", "featured": True},
                ]),
            ),
            final_cta(
                "Нужен взвешенный разбор, а не быстрый вердикт?",
                "Подключите «Экспертное мнение» — несколько моделей разберут сложный вопрос по вашим документам и соберут итог с точками согласия и расхождения.",
                ("Попробовать бесплатно", "https://app.zakon-ai.ru"),
                ("Узнать о тарифах", "https://app.zakon-ai.ru"),
            ),
        ],
