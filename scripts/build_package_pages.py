...
PACKAGES = [
    ...
    },
    {
        ...
        "hero_icon": "landmark",
        "status": ("Скоро", "soon"),
        "lead": "ИИ-эксперт по нормативной базе рынка электроэнергии и мощности: ответы по нормам со ссылками на пункты документов. Пакет дорабатывается — скоро в каталоге.",
        "sections": lambda: [
            section(
                "target",
                "Зачем нужен этот пакет",
            ...
            section(
                ...
                "Статус запуска",
                """
                <p><strong>Пакет «Энергетика» сейчас дорабатывается.</strong> Мы улучшаем качество ответов и покрытие нормативной базы перед открытым подключением для всех пользователей.</p>
                <p>Оставьте заявку — сообщим о запуске. А пока можно <a href="../cases/energy.html">прочитать кейс пилота</a> и посмотреть, как работает помощник на реальных задачах отрасли.</p>
                """,
            ),
            section(
                "stack",
            ...
            section(
                ...
                "Стоимость",
                price_grid([
                    {"label": "Статус", "value": "Скоро", "note": "Подключение появится после завершения доработки пакета.", "featured": True},
                ]),
            ),
            final_cta(
                "Хотите узнать о запуске первыми?",
                "Пакет «Энергетика» скоро появится в открытом каталоге. Оставьте заявку — расскажем о возможностях и подключим в числе первых.",
    ...
    },
    {
        ...
        "meta_description": "ИИ-эксперт по созданию презентаций: структура, слайды, тексты и спикерские заметки.",
        "hero_icon": "presentation",
        "status": ("Скоро", "soon"),
        "lead": "ИИ-эксперт по созданию презентаций: структура, слайды, тексты и спикерские заметки — от идеи до готового каркаса. Пакет готовится к запуску.",
        "sections": lambda: [
            section(
                "presentation",
                "Зачем нужен этот пакет",
            ...
            final_cta(
                "Хотите узнать о запуске первыми?",
                "Пакет «Презентации» скоро появится в приложении. Оставьте заявку — расскажем о возможностях и подключим в числе первых.",
                ("Оставить заявку", "../index.html#contact"),
                None,
            ),
        ],
