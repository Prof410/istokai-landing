(function () {
  ...
  const I18N = {
    ru: {
      ...
      "hero.lead1":
        "Zakon-AI — ИИ-эксперт, который отвечает по вашим документам и нормативке: договоры, регламенты, инструкции, отраслевые акты.",
      "hero.lead2":
      ...
      "pricing.pkg3.text":
        "ИИ-эксперт для разбора бухгалтерской, финансовой и налоговой отчётности юридических лиц. Структурированный разбор за минуты: коэффициенты, тренды и риски с опорой на загруженные отчёты.",
      "pricing.pkg3.status": "Скоро",
      "pricing.pkg4.title": "Презентации",
      "pricing.pkg4.text":
        "ИИ-эксперт по созданию презентаций: структура, слайды, тексты и спикерские заметки. От идеи до готового каркаса — для совещания, питча, отчёта или обучения.",
